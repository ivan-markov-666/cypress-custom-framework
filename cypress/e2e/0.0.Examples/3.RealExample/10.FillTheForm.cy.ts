 ...
 *                    The best of the best practice we can use for the spec (test) class.
...
import { FillTheForm_10_po } from "../../pom/0.0.Examples/3.RealExample/FillTheForm_10_po"; // Import PO class.
...
const po = new FillTheForm_10_po(); // PO class constructor.
