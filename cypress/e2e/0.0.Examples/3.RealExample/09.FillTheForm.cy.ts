 ...
 *                      - We use domain-specific language from a low level (custom Cypress commands) - in the PO class.
...
import { FillTheForm_09_po } from "../../pom/0.0.Examples/3.RealExample/FillTheForm_09_po"; // Import PO class.
...
const po = new FillTheForm_09_po(); // PO class constructor.
