...
var functionName = "alertWindowOk";
...
Cypress.Commands.add(
  ...
  (subject, alertMessage, pauseTime) => {
    ...
    try {
      ...
      // This example shows how to press the "OK" button of the alert (pop-up) window. This example can be used when the alert (pop-up) window contains both the 'OK' and 'CANCEL' buttons.
      // Actually, Cypress makes this action automatically. When the browser shows an alert (pop-up) window - Cypress automatically presses the "OK" button.
