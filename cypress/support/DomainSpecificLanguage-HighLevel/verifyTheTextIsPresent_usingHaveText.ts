...
export class verifyTheTextIsPresent_usingHaveText {
   ...
   */
  verifyTheTextIsPresent_usingHaveText(
    ...
    var functionName: any = "verifyTheTextIsPresent_usingHaveText";
    ...
    try {
      ...
      cy.element(elementSelector, element, 20000).verifyHaveText(
        containingText
      );
